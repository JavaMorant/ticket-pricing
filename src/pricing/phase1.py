...
def build(run: phaseio.Run) -> list[Path]:
    ...
    lines += [
        ...
        "significance claim and no out-of-sample confirmation. Those are gated on",
        "`preregistration.md` being frozen (SPEC.md §5.3) and it still says DRAFT. Testing a",
        "pattern you noticed while making this report is SPEC.md §5.2, the cardinal sin.",
        "",
